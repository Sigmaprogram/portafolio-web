...
//                 <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl">Experiencia Profesional</h1>
//                 <p className="max-w-[700px] text-muted-foreground md:text-xl/relaxed">
//                   Mi trayectoria laboral y los roles que he desempeñado a lo largo de mi carrera.
//                 </p>
//               </div>
//             </div>
...
//                     </div>
//                     {index < experience.length - 1 && <div className="h-full w-0.5 bg-border"></div>}
//                   </div>
